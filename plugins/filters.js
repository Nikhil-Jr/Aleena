...
const array = ['Da','Aleena','Hi','song','Ayye','va','Poda','va','wow','Ayin','ayn','back','Back','Bot','fuck','Fuck','Hehe','Hello','Hlo','Kill','Ombi','Sed','Killadi','kiss','line','love','mwolu','Neymar','Mwolu','Tnx','single','Sulthan','Evide','tha','thund','z','Z']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
