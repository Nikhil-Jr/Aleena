...
const array = ['Da','Aleena','Sulthan','Ayye','va','Poda','Sed','va','wow','Ayin','ayn','back','Back','Bot','fuck','Fuck','Hehe','Hello','Hlo','Kill','kill','kiss','line','love','mwolu','Neymar','Mwolu','single','tha','thund','z','Z']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
