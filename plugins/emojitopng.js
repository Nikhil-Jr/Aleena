...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'emoj ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*Made by MsJessica*'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Asena.addCommand({pattern: 'emoj ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
